...
getInput3 :: Getting a s a -> Getting b s b -> Getting c s c -> s -> (a, b, c)
getInput3 f1 f2 f3 s = (view f1 s, view f2 s, view f3 s)
...
getInput4
  ...
  -> s
  -> (a, b, c, d)
getInput4 f1 f2 f3 f4 s = (view f1 s, view f2 s, view f3 s, view f4 s)
...
getInput5 f1 f2 f3 f4 f5 s =
  (view f1 s, view f2 s, view f3 s, view f4 s, view f5 s)
...
getInput6 f1 f2 f3 f4 f5 f6 s =
  (view f1 s, view f2 s, view f3 s, view f4 s, view f5 s, view f6 s)
...
setOutput3
  :: ASetter' s a -> ASetter' s b -> ASetter' s c -> s -> (a, b, c) -> s
