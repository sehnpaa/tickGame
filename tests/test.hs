...
state1 :: MyState
state1 = MyState defaultConfig [] [] (Resources 0 2 100) 0 (IsStarted True)

tests :: TestTree
tests = testGroup "Tests" [unitTests, qcTests]

unitTests = testGroup "Unit tests"
  [ testCase "first" $ assertEqual "" (MyState defaultConfig [] [] (Resources 4 2 100) 1 (IsStarted True)) (nextTick state1)]
