...
state1 :: MyState
state1 = MyState defaultConfig [] [] (Research NotResearched) (Resources 0 2 0 100) 0 (IsStarted True)

tests :: TestTree
tests = testGroup "Tests" [unitTests, qcTests]

unitTests = testGroup "Unit tests"
  [ testCase "first" $ assertEqual "" (MyState defaultConfig [] [] (Research NotResearched) (Resources 4 2 0 100) 1 (IsStarted True)) (nextTick state1)]
